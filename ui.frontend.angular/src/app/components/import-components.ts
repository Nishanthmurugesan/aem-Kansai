 ...
 */
MapTo('kansai/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('kansai/components/separator')(SeparatorV1Component);

MapTo('kansai/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('kansai/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('kansai/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('kansai/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('kansai/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('kansai/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('kansai/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('kansai/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('kansai/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('kansai/components/accordion')(AccordionV1Component);
MapTo('kansai/components/tabs')(TabsV1Component);
...
LazyMapTo('kansai/components/teaser')(TeaserV1Component);
...
LazyMapTo('kansai/components/carousel')(CarouselV1Component);
...
LazyMapTo('kansai/components/text')(LazyTextModule, TextEditConfig);